...
DEFAULT_SETTINGS = {
    ...
    "full_scan_resume_enabled": True,
    "full_scan_max_retries_per_step": 5,
    "full_scan_retry_base_seconds": 5,
    "full_scan_retry_max_seconds": 300,
    "full_scan_checkpoint_flush_pages": 3,
    "poll_minutes": 60,
